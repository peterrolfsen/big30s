...
export const tripConfig = {
  ...
  // Alle deltakere med bilder og type
  participants: [
    // Jubilanter
    { name: "Peter Rolfsen", type: "celebrant" as const, image: null, birthday: "11. juli" },
    { name: "Anders Spjøtvold", type: "celebrant" as const, image: null, birthday: "21. august" },
    { name: "Johannes Steen", type: "celebrant" as const, image: null, birthday: null },
    { name: "Tor Simen Berntsen", type: "celebrant" as const, image: "/30year/deltakere/Tor.png", birthday: "23. desember" },
    { name: "Bror Dypfest", type: "celebrant" as const, image: null, birthday: null },
    { name: "Martin Hagen", type: "celebrant" as const, image: "/30year/deltakere/Martin.png", birthday: "15. oktober" },
    { name: "Magnus Jordfald", type: "celebrant" as const, image: null, birthday: null },
    { name: "Joffe", type: "celebrant" as const, image: "/30year/deltakere/Joffe.png", birthday: "18. juni" },
    // Gjester
    { name: "Holtan", type: "guest" as const, image: "/30year/deltakere/Holtan.png", birthday: null },
    { name: "Joachim", type: "guest" as const, image: "/30year/deltakere/Joachim.png", birthday: null },
    { name: "Ellen", type: "guest" as const, image: null, birthday: null },
    { name: "Erika", type: "guest" as const, image: null, birthday: null },
    { name: "Eir", type: "guest" as const, image: null, birthday: null },
    { name: "Hedda", type: "guest" as const, image: null, birthday: null },
    { name: "Michelle", type: "guest" as const, image: null, birthday: null },
    { name: "Fredrik", type: "guest" as const, image: null, birthday: null },
    { name: "Ulrik", type: "guest" as const, image: null, birthday: null },
    { name: "Eystein", type: "guest" as const, image: null, birthday: null },
    { name: "Mats", type: "guest" as const, image: null, birthday: null },
  ],
